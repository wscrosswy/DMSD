...
public class JanusBijector extends AbstractGraphBijector implements GraphBijector {

    final static Logger log = LoggerFactory.getLogger(JanusBijector.class);

    TinkerGraph graph;

    public JanusBijector(final Map<String, String> options) {
        super(options);
    };
